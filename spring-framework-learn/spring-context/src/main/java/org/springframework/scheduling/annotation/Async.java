...
/**
 *
 * 可以在类上使用该注解，也可以在类中方法上使用
 * 但不支持在配有@Configuration注解里的方法使用
 *
 ...
 *
 * 支持所有的参数类型，但是返回值要么是void要么是Future
 *
...
public @interface Async {
	 ...
	 *
	 * 当在类级别的@Async注释上指定时，表示给定的执行器应该用于类中的所有方法。async#value的方法级使用总是覆盖在类级设置的任何值。
	 * @since 3.1.2
	 */
