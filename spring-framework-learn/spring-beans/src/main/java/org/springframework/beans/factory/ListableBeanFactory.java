 ...
 *
 * BeanFactory的扩展接口，可让工厂列出自己的所有bean实例，而不是通过名称去一个个检索
 * 实现这个接口的BeanFactory可以预加载其bean definitions
 * HierarchicalBeanFactory，返回值不会附带任何的层级信息
 *
 * @author Rod Johnson
...
public interface ListableBeanFactory extends BeanFactory {
	 ...
	 *
	 * 不考虑这个工厂参与任何层级结构，同时忽略通过其他方式注册的任何单例实例beans
	 *
